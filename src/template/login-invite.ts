const loginInvite = (firstName: string, url: string) => {
    return `
    <!DOCTYPE html>
    <html>
    ...
    <body>
        <div class="email-body">
            ...
            <div class="email-content">
                ...
                <p>You have been provided a one-time login link to access our platform. Please use the link below to log in:</p>
                <div class="email-button">
                    <a href="${url}" target="_blank">Log In</a>
                </div>
                <p>If the button doesn't work, copy and paste the following link into your browser:</p>
                <p><a href="${url}" target="_blank">${url}</a></p>
                <p><strong>Note:</strong> This link is valid for <strong>10 minutes</strong> only and can be used <strong>once</strong>. If it expires, you will need to request a new login link.</p>
